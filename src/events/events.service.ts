...
import { FT_CACHED_EVENTS_CACHE_KEY, FT_DEFAULT_EVENTS_LIST } from '../common/constants/ft-api-cache';
...
export class EventsService {
  ...
  async prefetchAllEvents() {
    ...
    await this.cacheManager.set(FT_CACHED_EVENTS_CACHE_KEY, events);
  }
